...
\begin{problem}{3a}
    ...
    \end{center}
    \textbf{c. Draw each trace for the coordinate planes and discribe the conic section. Label and scale your axes.}
    \begin{align*}
    ...
    \end{align*}
    \newpage
    \textbf{d. Graph $9y^2 + 4z^2 = x^2 + 36$. Label and scale the axes.}\\
